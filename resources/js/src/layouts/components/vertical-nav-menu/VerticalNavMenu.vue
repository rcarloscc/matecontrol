<template>
  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        ...
        <v-slide-x-transition>
          <h2 class="app-title text--primary">ChatControl</h2>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      <nav-menu-section-title title="Funciones Adicionales"></nav-menu-section-title>
      <nav-menu-link title="Bot's" :to="{ name: 'bots' }" :icon="icons.mdiAlphaTBoxOutline"></nav-menu-link>
      <nav-menu-link title="Envios's" :to="{ name: 'envios' }" :icon="icons.mdiApproximatelyEqualBox"></nav-menu-link>
